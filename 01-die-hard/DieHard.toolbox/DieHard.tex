...
\@x{ {\EXTENDS} Integers}%
\@x{ {\VARIABLES} big ,\, small}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} big\@s{10.88} \.{=} 0}%
\@x{\@s{35.70} \.{\land} small \.{=} 0}%
\@pvspace{8.0pt}%
 \@x{ TypeOK \.{\defeq}\@s{4.1} \.{\land} big\@s{10.88} \.{\in} 0 \.{\dotdot}
 5}%
\@x{\@s{60.24} \.{\land} small \.{\in} 0 \.{\dotdot} 3}%
\@pvspace{8.0pt}%
\@x{ FillBig \.{\defeq}\@s{10.54} \.{\land} big \.{'}\@s{10.88} \.{=} 5}%
\@x{\@s{60.24} \.{\land} small \.{'} \.{=} small}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{ BigToSmall\@s{2.04} \.{\defeq} {\IF} big \.{+} small \.{\leq} 5}%
\@x{\@s{80.90} \.{\THEN} \.{\land} big \.{'}\@s{10.88} \.{=} big \.{+} small}%
\@x{\@s{112.21} \.{\land} small \.{'} \.{=} 0}%
\@x{\@s{80.90} \.{\ELSE} \.{\land} big \.{'}\@s{10.88} \.{=} 5}%
\@x{\@s{112.21} \.{\land} small \.{'} \.{=} small \.{-} ( 5 \.{-} big )}%
\@pvspace{8.0pt}%
\@x{ SmallToBig\@s{2.19} \.{\defeq} {\IF} big \.{+} small \.{\leq} 3}%
\@x{\@s{80.90} \.{\THEN} \.{\land} small \.{'} \.{=} big \.{+} small}%
\@x{\@s{112.21} \.{\land} big \.{'}\@s{10.88} \.{=} 0}%
\@x{\@s{85.00} \.{\ELSE} \.{\land} small \.{'} \.{=} 3}%
 \@x{\@s{116.31} \.{\land} big \.{'}\@s{10.88} \.{=} big \.{-} ( 3 \.{-} small
 )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} FillBig}%
\@x{\@s{39.83} \.{\lor} FillSmall}%
